 ...
 *----------------------------------------------------------------------------*/
uint32_t SystemCoreClockX = __SYSTEM_CLOCK;      /* System Clock Frequency     */


/*----------------------------------------------------------------------------
  Clock functions
 *----------------------------------------------------------------------------*/
void SystemCoreClockUpdateX (void)               /* Get Core Clock Frequency   */
{
  uint32_t oscClk = 0;
  ...
  switch (LPC_SYSCON->MAINCLKSEL & 0x03) {
    case 0:                                     /* Internal RC oscillator     */
      SystemCoreClockX = __IRC_OSC_CLK;
      break;
    case 1:                                     /* Input Clock to System PLL  */
      switch (LPC_SYSCON->SYSPLLCLKSEL & 0x03) {
        ...
        case 1:                                 /* System oscillator          */
          SystemCoreClockX = __SYS_OSC_CLK;
          break;
        case 2:                                 /* Reserved                   */
          SystemCoreClockX = 0;
          break;
        case 3:                                 /* 32 kHz clock               */
          SystemCoreClockX = __RTC_OSC_CLK;
          break;
      }
      break;
    case 2:                                     /* WDT Oscillator             */
      SystemCoreClockX = oscClk;
      break;
    case 3:                                     /* System PLL Clock Out       */
      switch (LPC_SYSCON->SYSPLLCLKSEL & 0x03) {
        case 0:                                 /* Internal RC oscillator     */
          SystemCoreClockX = __IRC_OSC_CLK * ((LPC_SYSCON->SYSPLLCTRL & 0x01F) + 1);
          break;
        case 1:                                 /* System oscillator          */
          SystemCoreClockX = __SYS_OSC_CLK * ((LPC_SYSCON->SYSPLLCTRL & 0x01F) + 1);
          break;
        case 2:                                 /* Reserved                   */
        case 3:                                 /* Reserved                   */
          SystemCoreClockX = 0;
  ...
  SystemCoreClockX /= LPC_SYSCON->SYSAHBCLKDIV;
